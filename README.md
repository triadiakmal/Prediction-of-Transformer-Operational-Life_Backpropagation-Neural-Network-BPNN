...
for sheet_name, result in all_results.items():
    ...
    # Menympan data prediksi historis ke Excel
    ...
    # Membuat dan menyimpan grafik perbandingan (2021-2024)
    ...
    # Membuat dan menyimpan GRAFIK PROYEKSI BARU ke tahun 2030
    ...
    # Membuat dan plot garis proyeksi
